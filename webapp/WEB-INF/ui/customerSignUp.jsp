            ...
            <div class="col-12 ">
                <div style="padding-top: 50%; border-radius: 25px" class=" mt-5 center  justify-content-center mdc-card p-4 align-middle shadow" style="width: 300px">
                    <div class="card-body ">
                        ...
                        <hr>
                        <form:form class="align-middle" action="" onsubmit="return validateForm()">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            ...
                                            <form:input type="text" class="form-control" id="username" autocomplete="off" name="username" aria-describedby="customerIdHelp" data-toggle="popover" placeholder="123456"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="text" class="form-control" id="customerName" autocomplete="off" name="customerName" aria-describedby="customerUsernamehelp" data-toggle="popover" placeholder=" John Dae..."
                                                title="Name must be alphabetic" data-content="Name doesn't contain any special characters"/>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="text" class="form-control" id="customerEmailId" autocomplete="off" name="customerEmailId" placeholder="abc@mail_id.com " data-toggle="popover" title="emailID"
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <div class="mdc-form-field">
                                                <div class="mdc-radio mt-1">
                                                    <form:input class="mdc-radio__native-control" type="radio" id="male" name="custGender"/>
                                                ...
                                                <div class="mdc-radio mt-1">
                                                    <form:input class="mdc-radio__native-control" type="radio" id="female" name="custGender"/>
                                                    <div class="mdc-radio__background">
                                                        <div class="mdc-radio__outer-circle"></div>
                                                        <div class="mdc-radio__inner-circle"></div>
                                                    </div>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="date" class="form-control" id="InputDate" name="DOB" min="1950-12-31" max="2000-12-31" placeholder="yyyy-mm-dd"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="tel" class="form-control" id="customerContactNo" autocomplete="off" name="customerContactNo" aria-describedby="phoneNumberHelp" placeholder="+XX-XXXXXXXXXX"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="password" class="form-control" id="password" name="password" placeholder="Password" data-toggle="popover" title="password must be alphabetic" data-content=""/>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="password" class="form-control mt-3" id="confirmPassword" name="confirmPassword" placeholder="re-enter password" data-toggle="popover" title="exactly same as password" data-content=""/>
